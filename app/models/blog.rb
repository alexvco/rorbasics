class Blog < ApplicationRecord
  ...
  def self.id_less_than(id)
    ...
    # [#<Blog id: 2, user_id: 1, title: "public blog title 2", body: "body of public blog 2", status: "Private",
    # created_at: "2020-08-01 02:41:19", updated_at: "2020-08-05 06:49:03">]>
    ...
    # => [{"id"=>2, "user_id"=>1, "title"=>"public blog title 2", "body"=>"body of public blog 2",
    # "status"=>0, "created_at"=>2020-08-01 02:41:19 UTC, "updated_at"=>2020-08-05 06:49:03 UTC}]
  end
end
